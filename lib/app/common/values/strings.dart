class Strings {
  ...
  static String weatherNow = 'Weather now';

  static String minTemp = 'Min temp';

  static String maxTemp = 'Max temp';

  static String windSpeed = 'Wind speed';

  static String humidity = 'Humidity';

  static var searchCityName = "Search city name ... ";
  ...
  static const String appName = 'Flyin Manager';
